...
阶段一 JIT-free 24 B 裁槽可独立进入实现；阶段二 16 B 档等待显式 PGO-free 产品决策。两阶段只缩小 cell 尺寸，不改变数量、创建时机或共享语义。前台快照累计收益分别为 0.518 MiB 和 1.037 MiB，后台 full-GC 分别为 0.440 MiB 和 0.881 MiB。
